# Generated by Django 2.0 on 2017-12-15 10:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='uploads/blogs_avatars/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PN', 'Pending'), ('AP', 'Approved'), ('RJ', 'Rejected')], default='Pending', max_length=50, verbose_name='status')),
        ...
        migrations.AddField(
            model_name='blogpost',
            name='publisher',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='published_blogposts', to=settings.AUTH_USER_MODEL, verbose_name='publisher'),
        ),
        migrations.AddField(
            model_name='blog',
            name='contributors',
